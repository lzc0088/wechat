	...
	$uploadDom.each(function(index, obj) {
		setTimeout(function(){
			...
			$('#upload_picture_'+name).uploadify({
				...
				"removeTimeout"	  : 1,
				"fileTypeExts"	  : "*.bmp; *.jpeg; *.jpg; *.png; *.gif;",
				"fileSizeLimit"	  : '5MB',
				"overrideEvents"  : ['onDialogClose', 'onSelectError'],
				"onSelectError"   : onSelectFileError,				
...
//上传附件组件
function initUploadFile(opts, callback){
	var exts = (opts && opts.exts) ? opts.exts : '';
	var sizeLimit = (opts && opts.sizeLimit) ? opts.sizeLimit : '';
	//console.log(exts);
		...
		setTimeout(function(){
			...
			$("#upload_file_"+name).uploadify({
				...
				"onUploadError" : function(file, data, response) {
					//console.error('error');
					//console.error(data);
					onUploadImsSuccess(file, data, name);
				}
			});
		},200);
	});
}								
var onSelectFileError = function onSelectFileError(file, errorCode, errorMsg) {
	var msgText = "上传失败：\n";
	switch (errorCode) {
		...
		case SWFUpload.QUEUE_ERROR.INVALID_FILETYPE:
			msgText += "    文件格式不正确（" + this.setting.fileTypeExts + "）";
			break;
		default:
...
(function(){
	...
	*/
	...
	function openImageMsg(dataUrl,callback,title,inputname){
		var $contentHtml = $('<div class="appmsg_dialog" style="padding:10px; max-height:470px;overflow-y:auto;overflow-x:hidden;"><ul class="mt_10"><center><br/><br/><br/><img src="'+IMG_PATH+'/loading.gif"/></center></ul></div>');
		$.Dialog.open(title?title:"选择图文素材",{width:1000,height:580},$contentHtml);
		$.ajax({
			url:dataUrl,
			data:{'type':'ajax'},
			dataType:'html',
	...
	function uploadImgDialog(maxNum,callback){
		var $contentHtml = $('<div class="upload_img_dialog"><div class="mult_imgs">'+
                ...
                '</div>'+
            '</div><div class="btn_bar"><a href="javascript:;" class="btn confirm_btn">确定</a>&nbsp;&nbsp;<a href="javascript:;" class="btn cancel_btn">取消</a></div></div>');
	...
	function openSelectGoods(dataUrl,callback){
		var $contentHtml = $('<div><div class="goods_dialog" style="padding:10px; height:470px;overflow-y:hidden;overflow-x:hidden;"><div class="mt_10"><iframe id="goodsIframe" name="goodsIframe" style="height:470px;width:100%; border:none" border="0" src="'+dataUrl+'&isAjax=ajax"></iframe></div></div><div class="btn_bar"><a href="javascript:;" class="btn confirm_btn">确定</a>&nbsp;&nbsp;<a href="javascript:;" class="btn cancel_btn">取消</a></div></div>');
		$.Dialog.open("选择商品",{width:1000,height:580},$contentHtml);
	...
	function openSelectShops(dataUrl,callback){
		var $contentHtml = $('<div><div class="goods_dialog" style="padding:10px; height:530px;overflow-y:auto;overflow-x:hidden;"><div class="mt_10"><iframe id="shopsIframe" name="shopsIframe" style="height:530px;width:100%; border:none" border="0" src="'+dataUrl+'&isAjax=ajax"></iframe></div></div><div class="btn_bar"><a href="javascript:;" class="btn confirm_btn">确定</a>&nbsp;&nbsp;<a href="javascript:;" class="btn cancel_btn">取消</a></div></div>');
	...
	function openSelectLists(dataUrl,count,title,callback){
		...
		var $contentHtml = $('<div><div class="goods_dialog" style="padding:10px; height:470px;overflow-y:hidden;overflow-x:hidden;"><div class="mt_10"><iframe id="usersIframe" name="usersIframe" style="height:530px;width:100%; border:none" border="0" src="'+dataUrl+'"></iframe></div></div><div class="btn_bar"><a href="javascript:;" class="btn confirm_btn">确定</a>&nbsp;&nbsp;<a href="javascript:;" class="btn cancel_btn">取消</a></div></div>');
		$.Dialog.open(title,{width:1000,height:580},$contentHtml);
	...
	*/
	function openSelectUsers(dataUrl,count,callback){
		...
		var $contentHtml = $('<div><div class="goods_dialog" style="padding:10px; height:470px;overflow-y:hidden;overflow-x:hidden;"><div class="mt_10"><iframe id="usersIframe" name="usersIframe" style="height:470px;width:100%; border:none" border="0" src="'+dataUrl+'"></iframe></div></div><div class="btn_bar"><a href="javascript:;" class="btn confirm_btn">确定</a>&nbsp;&nbsp;<a href="javascript:;" class="btn cancel_btn">取消</a></div></div>');
		$.Dialog.open("选择用户",{width:1000,height:580},$contentHtml);
