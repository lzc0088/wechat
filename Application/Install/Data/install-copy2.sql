...
(30, 0, '', '微商城', 0, 'Shop', '', '_self', 0, 0, 1),
(31, 1, '30', '我的店铺', 1, '', 'addon/Shop/Shop/summary', '_self', 0, 0, 1),
(32, 1, '30', '基本信息', 1, '', 'addon/Shop/Shop/edit', '_self', 0, 0, 1),
(33, 1, '30', '幻灯片', 1, '', 'addon/Shop/Slideshow/lists', '_self', 0, 0, 1),
(34, 1, '30', '商品分组', 1, '', 'addon/Shop/Category/lists', '_self', 0, 0, 1),
(35, 1, '30', '商品管理', 1, '', 'addon/Shop/Goods/lists', '_self', 0, 0, 1),
(36, 1, '30', '订单管理', 1, '', 'addon/Shop/Order/lists', '_self', 0, 0, 1),
(37, 1, '30', '模板管理', 1, '', 'addon/Shop/Template/lists', '_self', 0, 0, 1),
(38, 1, '30', '支付配置', 1, '', 'addon/Payment/Payment/lists', '_self', 0, 0, 1),
...
(8, 'public_link', '公众号与管理员的关联关系', 0, '', 1, '["uid","addon_status"]', '1:基础', '', '', '', '', 'uid|get_nickname|deal_emoji:18%管理员(不包括创始人)\r\naddon_status:授权的插件\r\nids:12%操作:[EDIT]|编辑,[DELETE]|删除', 20, '', '', 1398933192, 1447233745, 1, 'MyISAM', 'Core'),
