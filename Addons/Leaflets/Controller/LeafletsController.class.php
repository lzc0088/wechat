...
class LeafletsController extends AddonsController
{
    function _initialize()
    {
        ...
        $res ['title'] = '微信宣传页';
        $res ['url'] = addons_url ( 'Leaflets://Leaflets/config');
        $res ['class'] = 'current';
        $nav [] = $res;
    ...
    {
        $normal_tips = '可点击：<a target="_blank" href="' . U('home/Index/leaflets', array('token'=>get_token())) . '">预览</a>，<a id="copyLink" data-clipboard-text="' . U('home/Index/leaflets', array('token'=>get_token())) . '">复制链接</a><script type="application/javascript">$.WeiPHP.initCopyBtn("copyLink");</script>';
