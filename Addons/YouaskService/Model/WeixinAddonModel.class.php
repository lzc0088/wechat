    ...
    function reply($dataArr, $keywordArr = array())
    {
        ...
        if ($msgType == 'event') {
            ...
            if ($event == 'kf_create_session') {
                $replace = array( $KfAccount);
                $config ['jrkf'] = str_replace($search, $replace, $config ['jrkf']);
            ...
            if ($event == 'kf_switch_session') {
                ...
                $config ['zjkf'] = str_replace($search, $replace, $config ['zjkf']);
        ...
        switch ($config ['type3']) {
            case '3' :
                $articles [0] = array(
                    ...
                    'Url' => str_replace($search, $replace, $config ['url2'])
                );
