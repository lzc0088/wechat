...
class YouaskServiceController extends BaseController{
	...
	public function lists() {
		...
		$normal_tips = '工号管理：工号自动从微信平台获取，如有修改请&nbsp;<a href="'.$tongbugonghaoUrl.'">同步工号信息</a>，注意:<br/>&nbsp;&nbsp;&nbsp;1. 客服帐号@微信别名<br/>&nbsp;&nbsp;&nbsp;2. 微信别名如有修改，旧帐号使用旧的微信别名，新增的帐号使用新的微信别名 ';
	...
	function config() {
		// 使用提示
		$normal_tips = '微信客服是指微信公众平台自带的多客服系统，只有认证号才有此功能，注意：<br/>
